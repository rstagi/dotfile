...
Use `/browser-use` skill for browser automation. Prefer `--browser real` to preserve logins/cookies unless isolation needed.
...
- **Frontend**: validate with `browser-use --browser real --headed` after changes
